#!/usr/bin/env python3
"""
MINIBUS Lite v0.4.0 diagnostic runner.
...
def check_import_and_core_tests() -> None:
    rc, out, err = run([sys.executable, "-m", "unittest", "discover", "-s", str(ROOT / "tests"), "-v"], timeout=20)
    if rc == 0:
...
def main() -> int:
    ...
    print("MINIBUS Lite v0.4.0 diagnostic")
